...
def render_pil(city_one_name, city_one_county, city_one_weather, out, city_two_name = None, city_two_county = None, city_two_weather = None):
    ...
    try:
        ...
        big_number = ImageFont.truetype(
            "/usr/share/fonts/truetype/Urbanist-Black.ttf", 70, encoding="unic")
        ...
        def draw_city_data(x_position, city_name, county, weather_data, draw, y_position, city_number=1):
            ...
            if summary_width > max_width / 2.1:
                ...
                y_position += (summary_height * 2)# if summary_height < 15 else summary_height
            ...
            for day in weather_data.daily:
                ...
                if overide_font_size:
                    ...
                    dummy_width, text_height = get_size(section_font, "Ag") 
